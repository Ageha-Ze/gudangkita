...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static inset-y-0 right-0 z-50 w-72 bg-gradient-to-br from-slate-900/95 via-blue-900/95 to-purple-900/95 backdrop-blur-xl text-white border-r border-white/10 transition-transform duration-300 ease-in-out ${
